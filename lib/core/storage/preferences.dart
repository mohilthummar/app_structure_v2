...
class Preferences {
  ...
  static set user(User? value) => setModel<User>(_user, value!, (u) => jsonDecode(u.toString()));
  static User? get user => getModel<User>(_user, (json) => UserModel.fromJson(json).toEntity());
