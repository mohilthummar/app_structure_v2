...
TextTheme buildTextTheme(TextTheme base) {
  return base.copyWith(
    ...
    titleMedium: TextStyle(fontSize: 16.0, fontFamily: "OpenSans", color: AppColors.white, fontWeight: FontWeight.w600),
    ...
    headlineSmall: TextStyle(fontSize: 24.0, fontFamily: "OpenSans", color: AppColors.white, fontWeight: FontWeight.w700),
