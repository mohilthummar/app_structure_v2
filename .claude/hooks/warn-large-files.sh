...
case "$FILE_PATH" in
  ...
  .dart_tool/*|*/.dart_tool/*)
    REASON="Cannot write into .dart_tool/. This is a Dart/Flutter build cache." ;;
  ios/Pods/*|*/ios/Pods/*)
    REASON="Cannot write into ios/Pods/. These are CocoaPods-generated files." ;;
  android/.gradle/*|*/android/.gradle/*)
    REASON="Cannot write into android/.gradle/. This is a Gradle build cache." ;;
  *)
    REASON="" ;;
esac
